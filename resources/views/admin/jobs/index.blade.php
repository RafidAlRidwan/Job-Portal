                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input status-change" value="jobs/{{$job->id}}" {{ $job->status == 1 ? 'checked' : '' }} type="checkbox" id="flexSwitchCheckDefault">
                                ...
                                <td>
                                    ...
                                    {{-- <i class="bi bi-eye"></i>--}}
                                    {{-- </a>--}}
                                    <a href="{{ route('edit.job',$job->id) }}" class="btn btn-outline-secondary btn-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a href="javascript:void(0)" onclick="delete_row('delete/jobs/', {{ $job->id }})" class="btn btn-outline-danger btn-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Delete">
